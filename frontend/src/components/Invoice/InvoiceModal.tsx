  ...
  useEffect(() => {
    if (employee && isOpen) {
      ...
      invoiceService
        ...
        .catch(() => {
          // Automatic generated fallback invoice
          ...
          setInvoice({
            ...
            salaryDetails: {
              ...
              payableSalary: employee.payableSalary,
      ...
      <div className="modal-content p-6 max-w-3xl relative">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-[rgba(255,255,255,0.08)] mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="glass-button-secondary text-xs py-2 px-3 rounded-xl hidden sm:inline-flex"
            >
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-lg bg-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.1)] text-slate-400 hover:text-white flex items-center justify-center transition-all ml-2"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        {loading ? (
          ...
          /* Invoice Paper View */
          <div className="bg-[#091424] border border-[rgba(255,255,255,0.12)] rounded-2xl p-8 space-y-8 shadow-2xl relative overflow-hidden">
            {/* Emerald Corporate Header Banner */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-[rgba(255,255,255,0.1)]">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-[#10B981] to-[#0EA5E9] flex items-center justify-center text-white font-black text-2xl shadow-xl">
                  M
                </div>
                <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 p-4 rounded-xl bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] text-xs">
                <div>
                ...
                <div>
                  ...
                  <span className="badge-active">{employee.status}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-[rgba(14,165,233,0.08)] border border-[rgba(14,165,233,0.2)]">
              ...
              <div className="p-4 rounded-xl bg-[rgba(16,185,129,0.1)] border border-[rgba(16,185,129,0.3)] flex flex-col justify-center items-end text-right">
            ...
            <div className="pt-6 border-t border-[rgba(255,255,255,0.08)] flex items-center justify-between text-xs text-slate-400">
              <div className="flex items-center gap-2">
